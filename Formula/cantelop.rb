...
class Cantelop < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/stepandel/cantelop/releases/download/v0.1.0-rc.5/cantelop_0.1.0-rc.5_darwin_amd64.tar.gz"
      sha256 "cf7b6b4f487c04fba4af29698f72c2f828440db8f7e3945dd9d518ba53ed64c9"
    end

    if Hardware::CPU.arm?
      url "https://github.com/stepandel/cantelop/releases/download/v0.1.0-rc.5/cantelop_0.1.0-rc.5_darwin_arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/stepandel/cantelop/releases/download/v0.1.0-rc.5/cantelop_0.1.0-rc.5_linux_amd64.tar.gz"
      sha256 "56ecb82702238d07a52ccf4c652884f50c918af6e25bce0b44387e15313cdb8d"
    end

    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/stepandel/cantelop/releases/download/v0.1.0-rc.5/cantelop_0.1.0-rc.5_linux_arm64.tar.gz"
